...
Namespace Localization.Win
	Partial Public Class LocalizationWindowsFormsApplication
		...
		Private Sub LocalizationWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
