...
Namespace Localization.Web
	Partial Public Class LocalizationAspNetApplication
		...
		Private module3 As Localization.Module.LocalizationModule
		Private module4 As Localization.Module.Web.LocalizationAspNetModule
		...
		Private Sub LocalizationAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
		...
		Private Sub InitializeComponent()
			...
			Me.module3 = New Localization.Module.LocalizationModule()
			Me.module4 = New Localization.Module.Web.LocalizationAspNetModule()
			...
			' sqlConnection1
			' 
			Me.sqlConnection1.ConnectionString = "Data Source=(local);Initial Catalog=Localization;Integrated Security=SSPI;Pooling=false"
			Me.sqlConnection1.FireInfoMessageEventOnUserErrors = False
			' 
			' LocalizationAspNetApplication
			' 
			Me.ApplicationName = "Localization"
...
'			Me.DatabaseVersionMismatch += New System.EventHandler(Of DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs)(Me.LocalizationAspNetApplication_DatabaseVersionMismatch);
